...
function InitDateRange() {
    ...
    $(".dateRangeIssueDeadLine").daterangepicker({
        singleDatePicker: true,
        timePicker: false,
        locale: {
            format: 'Y-MM-DD'
    ...
    $(".dateRangeIssueOpenDate").daterangepicker({
        singleDatePicker: true,
        timePicker: false,
        locale: {
            format: 'Y-MM-DD'
    ...
    //$(".dateRangeDateOfSubmission").daterangepicker({
    //    singleDatePicker: true,
    //    timePicker: false,
    //    locale: {
    //        format: 'Y-MM-DD'
...
function addRowOthers($table) {
    ...
    $('<td>').html('<button type="button" class="btn btn-danger btn-sm remove-row-btnOthers"><i class="fa fa-trash"></i></button>').appendTo($row);
...
function initEditTableOthers($table, config) {
    ...
    debugger;
    $table.on('click', '.remove-row-btnOthers', function () {
...
function addRowLessAdvence($table) {
    var $row = $('<tr>');
    $table.find('thead th').each(function () {
        var type = $(this).data('type');
        var search = $(this).data('search');
    ...
    $('<td>').html('<button type="button" class="btn btn-danger btn-sm remove-row-btnLessAdvance"><i class="fa fa-trash"></i></button>').appendTo($row);
    $row.appendTo($table.find('tbody'));
...
function initEditTableLessAdvence($table, config) {
    ...
    debugger;
    $table.on('click', '.remove-row-btnLessAdvance', function () {
        $(this).closest('tr').remove();
    });
