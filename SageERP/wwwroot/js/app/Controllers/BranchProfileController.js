var BranchProfileController = function ( BranchProfileService) {
    ...
    $('.btnDelete').click('click', function () {
        Confirmation("Are you sure? Do You Want to Delete Data?", function (result) {
            console.log(result);
            if (result) {

                debugger;
                var form = $("#frm_Branch")[0];
                var formData = new FormData(form);              
                BranchProfileService.deleteBranch(formData, deleteDoneBranch, deleteFail);

            }
        });

    });
    function deleteDoneBranch(result) {
