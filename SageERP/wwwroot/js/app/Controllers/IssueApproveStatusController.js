var IssueApproveStatusController = function (CommonService, IssueApproveStatusService) {
    ...
    var IssueTable = function () {

        $('#IssueApproveStatusList thead tr')
            .clone(true)
            .addClass('filters')
            .appendTo('#IssueApproveStatusList thead');


        var dataTable = $("#IssueApproveStatusList").DataTable({
            orderCellsTop: true,
            fixedHeader: true,
            serverSide: true,
            "processing": true,
            ...
            ajax: {
                url: '/Audit/_issueApproveStatusIndex',
                type: 'POST',
            ...
            columns: [

                {
                    ...
                    render: function (data) {
                        ...
                        return "<a href=/Audit/Edit/" + data + "?edit=issueApprove class='edit btn btn-primary btn-sm' ><i class='fas fa-check tick-icon' data-toggle='tooltip' title='' data-original-title='Audit'></i></a>  "
        ...
        $("#IssueApproveStatusList").on("change",
            ".acc-filters",
            function () {
        ...
        $("#IssueApproveStatusList").on("keyup",
            ".acc-filters",
            function () {
...
}(CommonService, IssueApproveStatusService);