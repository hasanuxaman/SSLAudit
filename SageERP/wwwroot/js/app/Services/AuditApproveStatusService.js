var AuditApproveStatusService = function () {
    ...
    var MultipleAuditApproval = function (masterObj, done, fail) {

        $.ajax({
            url: '/Audit/MultipleAuditApproval',
            method: 'post',
            data: masterObj
    ...
    return {
        ...
        MultipleAuditApproval: MultipleAuditApproval
